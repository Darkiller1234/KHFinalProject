...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/static/css/common/member.css">
	<script src="${pageContext.request.contextPath}/resources/static/js/common/member.js"></script>
<title>회원가입</title>
</head>
<body>
    <div class="wrapper">
        ...
        <div class="innerOuter">
            ...
            <form action="insert.me" method="post" id="memberForm">
