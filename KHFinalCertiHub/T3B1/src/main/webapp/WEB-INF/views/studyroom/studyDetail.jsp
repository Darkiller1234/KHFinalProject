    ...
    <div class="wrapper padding">
        ...
        <div class="mentor-page">
            ...
            <div class="mentor-info">
                <div class="font-size-title">제 243921회 김순자 할머니와 함께하는 정보처리기사 스터디그룹</div>
                ...
                <div class="font-size-title">참여인원</div>
                ...
                <div class="button-section">
                    <button class="btn-primary" onclick="location.href='${pageContext.request.contextPath}/study/search'">목록으로</button>
                </div>
            </div>
