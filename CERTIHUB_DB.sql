...
COMMENT ON COLUMN MESSAGE.SENDER_NO IS '보낸사람번호';
COMMENT ON COLUMN MESSAGE.RECEIVER_NO IS '받는사람번호';
COMMENT ON COLUMN MESSAGE.STUDY_NO IS '받는스터디그룹(톡방)번호';
COMMENT ON COLUMN MESSAGE.MESSAGE_CONTENT IS '메시지 내용';
COMMENT ON COLUMN MESSAGE.MESSAGE_DATE IS '메시지작성일';
...
COMMENT ON COLUMN BOARD_LIKE_LOG.BOARD_NO IS '좋아요 누른 멤버번호';
...
COMMENT ON COLUMN BOARD_HATE_LOG.BOARD_NO IS '싫어요 누른 멤버번호';
...
VALUES(MEMBER_SEQ.NEXTVAL,'user01','pass01','김동영',
    'user01','rlaehddud9502@naver.com','010-1111-1111');
    
INSERT INTO MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME,
                    MEMBER_NICKNAME, EMAIL, PHONE)
VALUES(MEMBER_SEQ.NEXTVAL,'user02','pass02','윤대한',
    'user02','user02@naver.com','010-2222-2222');

INSERT INTO MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME,
                    MEMBER_NICKNAME, EMAIL, PHONE)
VALUES(MEMBER_SEQ.NEXTVAL,'user03','pass03','조동근',
    'user03','user03@naver.com','010-3333-3333');
    
INSERT INTO MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME,
                    MEMBER_NICKNAME, EMAIL, PHONE)
VALUES(MEMBER_SEQ.NEXTVAL,'user04','pass04','박상준',
