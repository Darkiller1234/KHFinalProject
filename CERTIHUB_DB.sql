...
CREATE TABLE BOARD(
    ...
    STATUS VARCHAR2(3) DEFAULT 'T' CHECK( STATUS IN ('Y','N','T')), -- 게시글 정상/삭제/임시
    VIEW_COUNT NUMBER DEFAULT 0,
...
CREATE TABLE STUDY_BOARD(
    ...
    STUDY_NO NUMBER,
    STUDY_BOARD_TITLE VARCHAR2(300),
    STUDY_BOARD_CONTENT VARCHAR2(3000),
    VIEW_COUNT NUMBER DEFAULT 0,
    STUDY_BOARD_DATE DATE,
    STATUS VARCHAR(3) DEFAULT 'T' CHECK( STATUS IN ('Y','N','T')), -- 게시글 정상/삭제/임시
...
COMMENT ON COLUMN STUDY_BOARD.STATUS IS '게시글상태(Y(정상)/N(삭제)/T(임시))';
