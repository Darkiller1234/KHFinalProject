...
DROP TABLE APPLY_LOG CASCADE CONSTRAINTS;
DROP TABLE REPORT_TYPE CASCADE CONSTRAINTS;
DROP TABLE BOARD_LIKE_LOG CASCADE CONSTRAINTS;
DROP TABLE BOARD_HATE_LOG CASCADE CONSTRAINTS;
DROP TABLE MEMBER_CALENDAR CASCADE CONSTRAINTS;
DROP TABLE MENTOR_LIKE_LOG CASCADE CONSTRAINTS;
DROP TABLE MEMBER_TALKROOM CASCADE CONSTRAINTS;
DROP TABLE MEMBER_LICENSE CASCADE CONSTRAINTS;
DROP TABLE MEMBER_LOOK_LICENSE CASCADE CONSTRAINTS;
DROP TABLE COMPILER_LOG CASCADE CONSTRAINTS;
DROP TABLE DATA_BOARD_ATTACH CASCADE CONSTRAINTS;
DROP TABLE DATA_BOARD CASCADE CONSTRAINTS;
DROP TABLE REPLYV CASCADE CONSTRAINTS;
...
DROP TABLE TALKROOM CASCADE CONSTRAINTS;
DROP TABLE STUDY CASCADE CONSTRAINTS;
DROP TABLE MEMBER CASCADE CONSTRAINTS;
DROP TABLE BOARD_TAB CASCADE CONSTRAINTS;
DROP TABLE LICENSE CASCADE CONSTRAINTS;
DROP TABLE CHATBOT_LOG CASCADE CONSTRAINTS;
--DROP TABLE CALENDAR;
...
COMMENT ON COLUMN MEMBER.SOCIAL IS '소셜종류';
COMMENT ON COLUMN MEMBER.SOCIAL_ID IS '소셜고유키';
...
COMMENT ON COLUMN STUDY.TALKROOM_NO IS '스터디톡방번호';
